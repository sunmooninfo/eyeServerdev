package com.eye.brand.util;

public class BrandResponseCode {
    ...
    public static final Integer BRAND_NAME_EXIST = 805;
    public static final Integer BRAND_INEXISTENCE = 815;
    public static final Integer BRAND_NOT_PERSON = 825;
