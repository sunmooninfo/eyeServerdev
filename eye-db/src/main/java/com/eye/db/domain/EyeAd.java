...
public class EyeAd implements Serializable {
    ...
    @ApiModelProperty(value = "PC广告宣传图片")
    ...
    public boolean equals(Object that) {
        ...
        EyeAd other = (EyeAd) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getName() == null ? other.getName() == null : this.getName().equals(other.getName()))
            && (this.getLink() == null ? other.getLink() == null : this.getLink().equals(other.getLink()))
            && (this.getUrl() == null ? other.getUrl() == null : this.getUrl().equals(other.getUrl()))
            && (this.getPcUrl() == null ? other.getPcUrl() == null : this.getPcUrl().equals(other.getPcUrl()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPcUrl() == null) ? 0 : getPcUrl().hashCode());
    ...
    public enum Column {
        ...
        pcUrl("pc_url", "pcUrl", "VARCHAR", false),
        appUrl("app_url", "appUrl", "VARCHAR", false),
