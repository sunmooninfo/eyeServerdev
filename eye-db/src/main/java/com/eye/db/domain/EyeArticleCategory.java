...
public class EyeArticleCategory implements Serializable {
    ...
    @ApiModelProperty(value = "0是内部链接,1是外部链接")
    ...
    public String toString() {
        ...
        sb.append(", inLink=").append(inLink);
    ...
    public boolean equals(Object that) {
        ...
        EyeArticleCategory other = (EyeArticleCategory) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getInLink() == null ? other.getInLink() == null : this.getInLink().equals(other.getInLink()))
            && (this.getOutLink() == null ? other.getOutLink() == null : this.getOutLink().equals(other.getOutLink()))
            && (this.getLinkValue() == null ? other.getLinkValue() == null : this.getLinkValue().equals(other.getLinkValue()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getInLink() == null) ? 0 : getInLink().hashCode());
        result = prime * result + ((getOutLink() == null) ? 0 : getOutLink().hashCode());
        result = prime * result + ((getLinkValue() == null) ? 0 : getLinkValue().hashCode());
    ...
    public enum Column {
        ...
        inLink("in_link", "inLink", "VARCHAR", false),
        outLink("out_link", "outLink", "VARCHAR", false),
        linkValue("link_value", "linkValue", "INTEGER", false),
