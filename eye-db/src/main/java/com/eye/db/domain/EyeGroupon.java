...
public class EyeGroupon implements Serializable {
    ...
    @ApiModelProperty(value = "团购规则ID，关联eye_groupon_rules表ID字段")
    ...
    @ApiModelProperty(value = "团购活动状态，开团未支付则0，开团中则1，团购成功则2，开团失败则3")
    ...
    public boolean equals(Object that) {
        ...
        EyeGroupon other = (EyeGroupon) that;
