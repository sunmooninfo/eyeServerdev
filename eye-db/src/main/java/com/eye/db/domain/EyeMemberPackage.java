...
public class EyeMemberPackage implements Serializable {
    ...
    @ApiModelProperty(value = "基于购买时间的有效月数")
    ...
    public boolean equals(Object that) {
        ...
        EyeMemberPackage other = (EyeMemberPackage) that;
    ...
    public enum Column {
        ...
        months("months", "months", "INTEGER", true),
