...
public class EyeOrder implements Serializable {
    ...
    @ApiModelProperty(value = "绛剧害闂ㄥ簵鍙?")
    ...
    public String toString() {
        ...
        sb.append(", commanderId=").append(commanderId);
    ...
    public boolean equals(Object that) {
        ...
        EyeOrder other = (EyeOrder) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getUserId() == null ? other.getUserId() == null : this.getUserId().equals(other.getUserId()))
            && (this.getOrderSn() == null ? other.getOrderSn() == null : this.getOrderSn().equals(other.getOrderSn()))
            && (this.getCommanderId() == null ? other.getCommanderId() == null : this.getCommanderId().equals(other.getCommanderId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCommanderId() == null) ? 0 : getCommanderId().hashCode());
    ...
    public enum Column {
        ...
        commanderId("commander_id", "commanderId", "INTEGER", false),
