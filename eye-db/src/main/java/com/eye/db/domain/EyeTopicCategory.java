...
public class EyeTopicCategory implements Serializable {
    ...
    @ApiModelProperty(value = "文章类目图标")
    private String iconUrl;

    @ApiModelProperty(value = "文章分类图片")
    ...
    @ApiModelProperty(value = "逻辑删除,0为启动，1为删除")
    ...
    public boolean equals(Object that) {
        ...
        EyeTopicCategory other = (EyeTopicCategory) that;
