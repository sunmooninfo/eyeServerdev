...
public class EyeUser implements Serializable {
    ...
    @ApiModelProperty(value = "APP登录openid")
    private String appOpenid;

    @ApiModelProperty(value = "微信开放平台绑定小程序微信用户唯一标识")
    ...
    public enum Column {
        ...
        appOpenid("app_openid", "appOpenid", "VARCHAR", false),
