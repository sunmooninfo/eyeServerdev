...
import com.eye.db.dao.EyeGrouponMapper;
...
@Service
public class EyeGrouponService {
    @Resource
    private EyeGrouponMapper mapper;
     ...
     * @return
     */
    public List<EyeGroupon> queryMyGroupon(Integer userId) {
     ...
     * @return
     */
    public List<EyeGroupon> queryMyJoinGroupon(Integer userId) {
        EyeGrouponExample example = new EyeGrouponExample();
     ...
     * @return
     */
    public EyeGroupon queryByOrderId(Integer orderId) {
        EyeGrouponExample example = new EyeGrouponExample();
     ...
     * @return
     */
    public List<EyeGroupon> queryJoinRecord(Integer id) {
        EyeGrouponExample example = new EyeGrouponExample();
     ...
     * @return
     */
    public EyeGroupon queryById(Integer id) {
        EyeGrouponExample example = new EyeGrouponExample();
     ...
     * @return
     */
    public EyeGroupon queryById(Integer userId, Integer id) {
        EyeGrouponExample example = new EyeGrouponExample();
    ...
    public int updateById(EyeGroupon groupon) {
     ...
     * @return
     */
    public int createGroupon(EyeGroupon groupon) {
     ...
     * @return
     */
    public List<EyeGroupon> querySelective(String rulesId, Integer page, Integer size, String sort, String order) {
        EyeGrouponExample example = new EyeGrouponExample();
        EyeGrouponExample.Criteria criteria = example.createCriteria();
    ...
    public List<EyeGroupon> queryByRuleId(int grouponRuleId) {
        EyeGrouponExample example = new EyeGrouponExample();
        example.or().andRulesIdEqualTo(grouponRuleId).andDeletedEqualTo(false);
        return mapper.selectByExample(example);
    }

    public List<EyeGroupon> queryByStatus(Short statusOn) {
        EyeGrouponExample example = new EyeGrouponExample();
        example.or().andStatusEqualTo(statusOn).andDeletedEqualTo(false);
        return mapper.selectByExample(example);
    }
}
