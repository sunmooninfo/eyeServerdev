...
public class ResponseUtil {
    ...
    //total总条数,page当前页码
    public static Object okList(List list,int total,int page,int limit){
    ...
    public static Object unbindMobile(){
        return fail(601,"未绑定手机号");
    }

    public static Object mobileError(){
        return fail(602,"绑定手机号错误");
    }
}
